...
public class Utility {
	...
	public synchronized static boolean handleProvincesResponse(
			HelloWeatherDB coolWeatherDB, String response) {
	 ...
	 * 解析和处理服务器返回的市级数据
	 */
	public static boolean handleCitiesResponse(HelloWeatherDB coolWeatherDB,
	 ...
	 * 解析和处理服务器返回的县级数据
	 */
	public static boolean handleCountiesResponse(HelloWeatherDB coolWeatherDB,
